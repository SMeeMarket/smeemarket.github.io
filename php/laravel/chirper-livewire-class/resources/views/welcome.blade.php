    ...
    <div class="flex flex-col items-center mt-6">
        ...
        <div class="mx-auto w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <form method="POST" action="{{ route('email') }}">
                ...
                <div class="mt-2">
                    <x-input-label for="toMail" :value="__('To')" />
                    <x-text-input id="toMail" class="block mt-1 w-full" type="email" name="toMail"
                        :value="old('toMail')" required />
                    <x-input-error :messages="$errors->get('toMail')" class="mt-2" />
                </div>
                <div class="mt-2">
                ...
                <div class="mt-2">
                    ...
                    <x-text-input id="message" class="block mt-1 w-full" type="text" name="message"
                        required>{{ old('message') }}</x-text-input>
                    <x-input-error :messages="$errors->get('message')" class="mt-2" />
                </div>
                <div class="flex items-center justify-end mt-4">
                    @if(session()->has('thanks'))
                    <marquee class="text-fuchsia-500">{{ session()->get('thanks') }}</marquee>
                    @endif
