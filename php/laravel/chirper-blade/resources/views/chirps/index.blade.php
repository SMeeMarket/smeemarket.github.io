<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        @foreach ($chirps as $chirp)
            <div class="mt-4 shadow-sm rounded-lg divide-y" style="background-color: #242526;">
                <div class="p-6 flex space-x-2" style="color: #E4E6EB">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 -scale-x-100" fill="none"
